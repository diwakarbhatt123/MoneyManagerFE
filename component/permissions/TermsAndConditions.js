...
Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</Text>
            ...
            <TouchableOpacity disabled={ !this.state.accepted } onPress={ ()=>fetch('https://ext-qamobile1-aws1.freecharge.in/hoh/api/userConsent', {
                                                                                method: 'POST',
                                                                                headers: {
                                                                                ...
                                                                                body: JSON.stringify({
                                                                                  ...
                                                                                  .then((responseJson) => {
                                                                                    ...
                                                                                    alert('Integrate PushSMS');

                                                                                    PermissionsAndroid.request('RECEIVE_SMS', {
